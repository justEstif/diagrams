...
const Cover: Page = () => (
  ...
  >
    ...
    <p
      style={{ fontSize: "var(--osd-size-body)", color: muted, maxWidth: 1200 }}
    >
...
<div
  style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 64 }}
>
