...
const Rule = ({ color = 'var(--osd-accent)', width = 110 }: { color?: string; width?: number }) => (
...
const Portrait = ({ src, alt, accent = 'var(--osd-accent)' }: { src: string; alt: string; accent?: string }) => (
...
const Bullet = ({ children, accent = 'var(--osd-accent)' }: { children: React.ReactNode; accent?: string }) => (
  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 24, fontSize: 38, lineHeight: 1.38 }}>
    <span style={{ width: 13, height: 13, marginTop: 19, flex: '0 0 auto', background: accent }} />
    <span>{children}</span>
  </div>
);
...
const CoinCard = ({
  ...
  >
    ...
    <div style={{ marginTop: 42, display: 'flex', flexDirection: 'column', gap: 24 }}>{children}</div>
  </div>
);
...
const Cover: Page = () => (
  <div style={fill}>
    ...
    <div style={{ position: 'absolute', inset: 0, padding: '120px 140px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div>
        <h1 style={{ ...display, margin: 0, maxWidth: 1320, fontSize: 'var(--osd-size-hero)' }}>
          Batman’s
          <br />
          no-kill rule
        </h1>
...
const SimpleRule: Page = () => (
  <div style={{ ...fill, display: 'grid', gridTemplateColumns: '1.18fr 0.82fr' }}>
    <div style={{ padding: '110px 100px 110px 130px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <Eyebrow>The moral boundary</Eyebrow>
      <h2 style={{ ...display, margin: '34px 0 0', fontSize: 92 }}>The rule sounds simple.</h2>
      <blockquote style={{ margin: '60px 0 0', paddingLeft: 34, borderLeft: '10px solid var(--osd-accent)', fontSize: 52, lineHeight: 1.2, fontWeight: 750 }}>
        “If I kill, I become like them.”
      </blockquote>
      <div style={{ marginTop: 56, fontSize: 58, fontWeight: 800, lineHeight: 1.08, maxWidth: 780 }}>
        But who is the rule really for?
      </div>
    </div>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingRight: 130 }}>
...
const WhoBenefits: Page = () => (
  <div style={{ ...fill, padding: '120px 140px' }}>
    ...
    <div style={{ marginTop: 74, display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 34 }}>
      <div style={{ background: colors.surface, padding: 46, borderRadius: 'var(--osd-radius)', borderBottom: '8px solid var(--osd-accent)' }}>
        <div style={{ ...display, fontSize: 110, color: 'var(--osd-accent)', opacity: 0.35 }}>01</div>
        <div style={{ marginTop: 34, fontSize: 42, fontWeight: 750 }}>Gotham’s victims</div>
      </div>
      <div style={{ background: colors.surface, padding: 46, borderRadius: 'var(--osd-radius)', borderBottom: `8px solid ${colors.muted}` }}>
        <div style={{ ...display, fontSize: 110, color: colors.muted, opacity: 0.35 }}>02</div>
        <div style={{ marginTop: 34, fontSize: 42, fontWeight: 750 }}>The criminals he fights</div>
      </div>
      <div style={{ background: colors.surfaceHigh, padding: 46, borderRadius: 'var(--osd-radius)', borderBottom: `8px solid ${colors.red}` }}>
        <div style={{ ...display, fontSize: 110, color: colors.red, opacity: 0.45 }}>03</div>
...
const JokerCycle: Page = () => (
  <div style={{ ...fill, display: 'grid', gridTemplateColumns: '0.78fr 1.22fr' }}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingLeft: 120 }}>
      <Portrait src={joker} alt="The Joker in a purple suit" accent={colors.red} />
    </div>
    <div style={{ padding: '110px 130px 110px 100px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <div style={{ marginTop: 55, display: 'flex', flexDirection: 'column', gap: 26 }}>
        ...
        <Bullet accent={colors.red}><strong>The cycle restarts.</strong></Bullet>
      </div>
      <div style={{ marginTop: 46, alignSelf: 'flex-start', background: colors.red, color: '#fff', padding: '16px 24px', fontSize: 34, fontWeight: 850 }}>
...
const JasonQuestion: Page = () => (
  <div style={{ ...fill, padding: '110px 140px' }}>
    <div style={{ position: 'absolute', right: 90, top: 70, ...display, fontSize: 290, color: '#fff', opacity: 0.035, transform: 'rotate(-8deg)' }}>WHY?</div>
    <Eyebrow color={colors.red}>Under the Red Hood</Eyebrow>
    <h2 style={{ ...display, margin: '30px 0 0', fontSize: 98 }}>Jason asks the obvious question.</h2>
    <div style={{ marginTop: 54, maxWidth: 1460, display: 'flex', flexDirection: 'column', gap: 23 }}>
    ...
    <div style={{ marginTop: 54, padding: '30px 38px', background: colors.surface, borderLeft: '10px solid var(--osd-accent)', fontSize: 42, lineHeight: 1.25 }}>
      Bruce’s answer: killing would not be impossible. It would be <strong style={{ color: 'var(--osd-accent)' }}>too easy</strong>.
    </div>
...
const Leash: Page = () => (
  <div style={{ ...fill, padding: '105px 140px' }}>
    ...
    <div style={{ marginTop: 58, display: 'grid', gridTemplateColumns: '0.9fr 1.1fr', gap: 72, alignItems: 'center' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 26 }}>
        <div style={{ background: 'var(--osd-accent)', color: 'var(--osd-bg)', padding: '28px 34px', fontSize: 46, fontWeight: 900 }}>
          Batman may intervene.
        </div>
        <div style={{ background: colors.redSoft, border: `3px solid ${colors.red}`, padding: '28px 34px', fontSize: 46, fontWeight: 900 }}>
...
const Identity: Page = () => (
  <div style={{ ...fill, padding: '110px 140px', background: `linear-gradient(135deg, ${colors.surface}, var(--osd-bg) 58%)` }}>
    <Eyebrow>The psychological defense</Eyebrow>
    <h2 style={{ ...display, margin: '28px 0 0', fontSize: 96 }}>The rule protects an identity.</h2>
    <div style={{ marginTop: 55, color: colors.muted, fontSize: 39, lineHeight: 1.5, maxWidth: 1450 }}>
      Batman will sacrifice his body, wealth, relationships, freedom—<span style={{ color: 'var(--osd-text)' }}>even his life</span>.
    </div>
    <div style={{ marginTop: 68, maxWidth: 1400, fontSize: 72, lineHeight: 1.12, fontWeight: 880 }}>
      Dying is acceptable.
      <br />
...
const Ras: Page = () => (
  <div style={{ ...fill, padding: '110px 140px', background: `radial-gradient(circle at 84% 20%, rgba(112,183,126,0.14), transparent 30%), var(--osd-bg)` }}>
    ...
    <div style={{ marginTop: 56, display: 'grid', gridTemplateColumns: '0.95fr 1.05fr', gap: 70 }}>
      <div style={{ background: colors.greenSoft, borderTop: `10px solid ${colors.green}`, padding: '42px 46px' }}>
        <div style={{ fontSize: 31, color: colors.green, fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase' }}>Ra’s will sacrifice</div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', fontSize: 53, fontWeight: 780, lineHeight: 1.25 }}>
        Restraint matters because total commitment can become <span style={{ color: colors.green }}>&nbsp;total control.</span>
      </div>
    </div>
...
const BaneAttack: Page = () => (
  <div style={{ ...fill, display: 'grid', gridTemplateColumns: '0.78fr 1.22fr', background: `linear-gradient(120deg, ${colors.redSoft}, var(--osd-bg) 42%)` }}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingLeft: 120 }}>
      <Portrait src={bane} alt="Bane wearing his mask" accent={colors.red} />
    </div>
    <div style={{ padding: '115px 130px 115px 100px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <Eyebrow color={colors.red}>Knightfall</Eyebrow>
      <h2 style={{ ...display, margin: '30px 0 0', fontSize: 94 }}>Bane finds the attack surface.</h2>
      <p style={{ margin: '52px 0 0', fontSize: 44, lineHeight: 1.42, maxWidth: 880 }}>
        He does not defeat Batman’s morality. He weaponizes Batman’s willingness to suffer.
      </p>
      <div style={{ marginTop: 52, display: 'flex', alignItems: 'center', gap: 20, color: colors.muted, fontSize: 31, fontWeight: 720 }}>
        <span>RELEASE THE ROGUES</span><span style={{ color: colors.red }}>→</span><span>FORCE RESCUES</span><span style={{ color: colors.red }}>→</span><span>WAIT</span>
      </div>
    </div>
...
const GothamSystem: Page = () => (
  <div style={{ ...fill, padding: '105px 130px' }}>
    <div style={{ position: 'absolute', right: 115, top: 80, width: 500, height: 500, opacity: 0.18 }}>
      <img src={gotham} alt="Gotham City skyline at night" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%', filter: 'grayscale(1) contrast(1.25)' }} />
    </div>
    <Eyebrow>Beyond individual villains</Eyebrow>
    <h2 style={{ ...display, margin: '28px 0 0', fontSize: 98, maxWidth: 1120 }}>Gotham is the bigger villain.</h2>
    <div style={{ marginTop: 58, maxWidth: 1120, display: 'flex', flexDirection: 'column', gap: 22 }}>
    ...
    <div style={{ marginTop: 52, display: 'inline-block', background: 'var(--osd-accent)', color: 'var(--osd-bg)', padding: '18px 28px', fontSize: 37, fontWeight: 900 }}>
...
const GreenArrowContrast: Page = () => (
  <div style={{ ...fill, display: 'grid', gridTemplateColumns: '0.78fr 1.22fr', background: `linear-gradient(120deg, ${colors.greenSoft}, var(--osd-bg) 42%)` }}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingLeft: 120 }}>
    ...
    <div style={{ padding: '110px 130px 110px 100px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <h2 style={{ ...display, margin: '30px 0 0', fontSize: 90 }}>Green Arrow believes rot can be removed.</h2>
      <div style={{ marginTop: 54, display: 'flex', flexDirection: 'column', gap: 25 }}>
        <div style={{ padding: '26px 32px', background: colors.surface, borderLeft: '9px solid var(--osd-accent)', fontSize: 42 }}><strong>Batman:</strong> hold the line, forever.</div>
        <div style={{ padding: '26px 32px', background: colors.greenSoft, borderLeft: `9px solid ${colors.green}`, fontSize: 42 }}><strong>Green Arrow:</strong> expose, shame, reform.</div>
      </div>
      <p style={{ margin: '48px 0 0', color: colors.muted, fontSize: 35, lineHeight: 1.4 }}>
...
const Verdict: Page = () => (
  <div style={{ ...fill, padding: '120px 140px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    ...
    <div style={{ marginTop: 62, paddingLeft: 34, borderLeft: `10px solid ${colors.red}`, color: colors.muted, fontSize: 45, lineHeight: 1.35, maxWidth: 1380 }}>
...
const Conversation: Page = () => (
  <div style={{ ...fill, padding: '100px 130px' }}>
    ...
    <div style={{ marginTop: 52, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }}>
      <div style={{ padding: '30px 34px', background: colors.surface, borderLeft: '8px solid var(--osd-accent)', fontSize: 32, lineHeight: 1.35 }}><strong style={{ color: 'var(--osd-accent)' }}>01</strong><br />Would you trust Batman more or less if he killed only the Joker?</div>
      <div style={{ padding: '30px 34px', background: colors.surface, borderLeft: `8px solid ${colors.red}`, fontSize: 32, lineHeight: 1.35 }}><strong style={{ color: colors.red }}>02</strong><br />Is distrust of himself enough when others remain at risk?</div>
      <div style={{ padding: '30px 34px', background: colors.surface, borderLeft: `8px solid ${colors.green}`, fontSize: 32, lineHeight: 1.35 }}><strong style={{ color: colors.green }}>03</strong><br />Does Bane prove Batman needs a rule about stopping?</div>
      <div style={{ padding: '30px 34px', background: colors.surface, borderLeft: `8px solid ${colors.muted}`, fontSize: 32, lineHeight: 1.35 }}><strong style={{ color: colors.muted }}>04</strong><br />If Gotham is the villain, what does justice look like?</div>
    </div>
...
const Credits: Page = () => (
  <div style={{ ...fill, padding: '120px 140px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    ...
    <h2 style={{ ...display, margin: '30px 0 0', fontSize: 90 }}>Stories built to test the rule.</h2>
    <div style={{ marginTop: 58, maxWidth: 1450, display: 'flex', flexDirection: 'column', gap: 24, color: colors.muted, fontSize: 34, lineHeight: 1.42 }}>
      <div><strong style={{ color: 'var(--osd-text)' }}>Batman:</strong> created by Bob Kane and Bill Finger.</div>
      <div><strong style={{ color: 'var(--osd-text)' }}>Ra’s al Ghul:</strong> created by Denny O’Neil, Neal Adams, and Julius Schwartz.</div>
      <div><strong style={{ color: 'var(--osd-text)' }}>Character portraits:</strong> DC.com.</div>
      <div><strong style={{ color: 'var(--osd-text)' }}>Gotham image:</strong> DC Comics, sourced through Wikimedia Commons.</div>
      <div><strong style={{ color: 'var(--osd-text)' }}>Discussion:</strong> adapted from the accompanying nb-vault note.</div>
    </div>
    <Rule />
  </div>
);
